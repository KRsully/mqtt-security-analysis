...
\begin{table}
\centering
\caption{Expected TLS Error Alerts for Various Certificate Configurations}
\resizebox{\linewidth}{!}{%
...
\hline
\rowcolor[rgb]{0.753,0.753,0.753} valid & valid              & not required                                                                                   & not required                                                                                             & none                                                                                    \\
valid                                   & expired            & valid                                                                                          & not required                                                                                             & certificate\_expired                                                                    \\
\rowcolor[rgb]{0.753,0.753,0.753} valid & unrecognized CA    & valid                                                                                          & not required                                                                                             & unknown\_ca                                                                             \\
valid                                   & valid              & \begin{tabular}[c]{@{}l@{}}valid: can't\\resolve CN\end{tabular}                               & not required                                                                                             & certificate\_unknown                                                                    \\
\rowcolor[rgb]{0.753,0.753,0.753} valid & valid              & valid                                                                                          & required; none                                                                                           & handshake\_failure                                                                      \\
valid                                   & valid              & valid                                                                                          & required; expired                                                                                        & certificate\_expired                                                                    \\
\rowcolor[rgb]{0.753,0.753,0.753} valid & valid              & valid                                                                                          & \begin{tabular}[c]{@{}>{\cellcolor[rgb]{0.753,0.753,0.753}}l@{}}required; \\unrecognized CA\end{tabular} & unknown\_ca                                                                             \\
                                        &                    &                                                                                                &                                                                                                          &                                                                                        
\end{tabular}
}
\end{table}
