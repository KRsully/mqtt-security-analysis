...
%In all caps, as requested...
\captionsetup{figurename=FIGURE, tablename=TABLE}

%extra space bewteen paragraphs, as requested
...
\begin{table}[hbtp]
\centering
\caption{Expected TLS Error Alerts for Various Certificate Configurations\label{table:expected-errors}}
\resizebox{\linewidth}{!}{%
\begin{tabular}{llll|l}
\hline
CA Certificate                          & Server Certificate & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Server\\Verification \\Certificate\end{tabular}} & Client Certificate                                                                                       & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Expected TLS \\Error Alert\end{tabular}}  \\ 
\hline
\rowcolor[rgb]{0.827,0.827,0.827} valid & valid              & not required                                                                                   & not required                                                                                             & none                                                                                    \\
valid                                   & expired            & valid                                                                                          & not required                                                                                             & certificate\_expired                                                                    \\
\rowcolor[rgb]{0.827,0.827,0.827} valid & unrecognized CA    & valid                                                                                          & not required                                                                                             & unknown\_ca                                                                             \\
valid                                   & unresolvable CN    & valid                                                                                          & not required                                                                                             & certificate\_unknown                                                                    \\
\rowcolor[rgb]{0.827,0.827,0.827} valid & valid              & valid                                                                                          & required; none                                                                                           & handshake\_failure                                                                      \\
valid                                   & valid              & valid                                                                                          & required; expired                                                                                        & certificate\_expired                                                                    \\
\rowcolor[rgb]{0.827,0.827,0.827} valid & valid              & valid                                                                                          & \begin{tabular}[c]{@{}>{\cellcolor[rgb]{0.827,0.827,0.827}}l@{}}required; \\unrecognized CA\end{tabular} & {\cellcolor[rgb]{0.8,0.8,0.8}}unknown\_ca                                              
\end{tabular}
}
\end{table}

We see in Table \ref{table:mosq-errors} that the mosquitto broker opts to simply echo the error that is provided by OpenSSL. This provides some useful information in the case of rows 2, and 3, and arguably misleading information on row 4. ``alert certificate expired'' and ``alert unknown ca'' could be considered actionable - however the definition of internal error is defined in the TLS1.2 specification as `` An internal error unrelated to the peer or the correctness of the protocol (such as a memory allocation failure) makes it impossible to continue.''\cite{tls1.2-errors}. This would suggest that the error is not due to any issue with the certificate or with the TLS protocol. In addition, these errors are not plainly human-readable, containing long error numbers and OpenSSL internal function names. \par
The clearest error message occurs on row 5, where the error text clearly states that the peer (the client) did not return a certificate.\par
The errors on rows 6 and 7 include the function name \texttt{tls\_process\_client\_certificate}, and the message ``certificate verify failed'', which lets the user know that there was an issue with the client certificate, but not what the issue was. If we capture the packets that cause this error, we see that despite the TLS alert error being set in the TLS headers, this information is not relayed through the broker's error message.

\begin{table}[hbtp]
\centering
\caption{Error Messages Generated by mosquitto(broker) Due to Certificate Errors\label{table:mosq-errors}}
\resizebox{\linewidth}{!}{%
\begin{tabular}{llll|l}
\hline
CA Certificate                          & Server Certificate & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Server\\Verification \\Certificate\end{tabular}} & Client Certificate                                                                                       & \multicolumn{1}{c}{Error Message}                                                                                                                                                                                 \\ 
\hline
\rowcolor[rgb]{0.827,0.827,0.827} valid & valid              & not required                                                                                   & not required                                                                                             & none                                                                                                                                                                                                              \\
valid                                   & expired            & valid                                                                                          & not required                                                                                             & \begin{tabular}[c]{@{}l@{}}OpenSSL Error[0]: error:14094415:SSL routines:\\ssl3\_read\_bytes:sslv3 alert certificate expired\end{tabular}                                                                         \\
\rowcolor[rgb]{0.827,0.827,0.827} valid & valid              & incorrect CA                                                                                   & not required                                                                                             & \begin{tabular}[c]{@{}>{\cellcolor[rgb]{0.827,0.827,0.827}}l@{}}OpenSSL Error[0]: error14094418:SSL routines:\\ssl3\_read\_bytes:tlsv1 alert unknown ca\end{tabular}                                              \\
valid                                   & unresolvable CN    & valid                                                                                          & not required                                                                                             & \begin{tabular}[c]{@{}l@{}}OpenSSL Error[0]: error14094438:SSL routines:\\ssl3\_read\_bytes:tlsv1 alert internal error\end{tabular}                                                                               \\
\rowcolor[rgb]{0.827,0.827,0.827} valid & valid              & valid                                                                                          & required; none                                                                                           & \begin{tabular}[c]{@{}>{\cellcolor[rgb]{0.827,0.827,0.827}}l@{}}OpenSSL Error[0]: error:1417C0C7:SSL routines: \\tls\_process\_client\_certificate: peer did not return a certificate\end{tabular}                \\
valid                                   & valid              & valid                                                                                          & required; expired                                                                                        & \begin{tabular}[c]{@{}l@{}}OpenSSL Error[0]: error:1417C086;SSL routines:\\tls\_process\_client\_certificate:certificate verify failed\end{tabular}                                                               \\
\rowcolor[rgb]{0.827,0.827,0.827} valid & valid              & valid                                                                                          & \begin{tabular}[c]{@{}>{\cellcolor[rgb]{0.827,0.827,0.827}}l@{}}required; \\unrecognized CA\end{tabular} & {\cellcolor[rgb]{0.8,0.8,0.8}}\begin{tabular}[c]{@{}>{\cellcolor[rgb]{0.8,0.8,0.8}}l@{}}OpenSSL Error[0]: error:1417C086;SSL routines:\\tls\_process\_client\_certificate:certificate verify failed\end{tabular} 
\end{tabular}
}
\end{table}
...
CA Certificate                          & Server Certificate & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Server\\Verification \\Certificate\end{tabular}} & Client Certificate                                                                                       & \multicolumn{1}{c}{Error Message}                                                                                                      \\ 
\hline
\rowcolor[rgb]{0.827,0.827,0.827} valid & valid              & not required                                                                                   & not required                                                                                             & Error: A TLS error occurred\tablefootnote{mosquitto\_pub and mosquitto\_sub require that server certificates are verified by clients}  \\
valid                                   & expired            & valid                                                                                          & not required                                                                                             & Error: A TLS error occurred                                                                                                            \\
\rowcolor[rgb]{0.827,0.827,0.827} valid & valid              & incorrect CA                                                                                   & not required                                                                                             & Error: A TLS error occurred                                                                                                            \\
valid                                   & unresolvable CN    & valid                                                                                          & not required                                                                                             & Error: A TLS error occurred                                                                                                            \\
\rowcolor[rgb]{0.827,0.827,0.827} valid & valid              & valid                                                                                          & required; none                                                                                           & Error: The connection was lost                                                                                                         \\
valid                                   & valid              & valid                                                                                          & required; expired                                                                                        & Error: The connection was lost                                                                                                         \\
\rowcolor[rgb]{0.827,0.827,0.827} valid & valid              & valid                                                                                          & \begin{tabular}[c]{@{}>{\cellcolor[rgb]{0.827,0.827,0.827}}l@{}}required; \\unrecognized CA\end{tabular} & {\cellcolor[rgb]{0.8,0.8,0.8}}Error: The connection was lost                                                                          
\end{tabular}
}
\end{table}
...
\begin{table}[hbtp]
\centering
\caption{Error Messages Generated by HiveMQ CE Due to Certificate Errors\label{table:hivemq-errors}}
\resizebox{\linewidth}{!}{%
\begin{tabular}{llll|l} 
\hline
CA Certificate                          & Server Certificate & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Server\\Verification \\Certificate\end{tabular}} & Client Certificate                                                                                       & \multicolumn{1}{c}{Error Message}                   \\ 
...
\rowcolor[rgb]{0.827,0.827,0.827} valid & valid              & incorrect CA                                                                                   & not required                                                                                             & SSL handshake failed                                \\
valid                                   & unresolvable CN    & valid                                                                                          & not required                                                                                             & SSL message transmission failed                     \\
\rowcolor[rgb]{0.827,0.827,0.827} valid & valid              & valid                                                                                          & required; none                                                                                           & SSL handshake failed                                \\
valid                                   & valid              & valid                                                                                          & required; expired                                                                                        & none                                                \\
\rowcolor[rgb]{0.827,0.827,0.827} valid & valid              & valid                                                                                          & \begin{tabular}[c]{@{}>{\cellcolor[rgb]{0.827,0.827,0.827}}l@{}}required; \\unrecognized CA\end{tabular} & {\cellcolor[rgb]{0.8,0.8,0.8}}SSL handshake failed 
\end{tabular}
}
\end{table}

\subsection{Parsing the TLS Layer}
As we see 
